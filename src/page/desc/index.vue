...
<script>
import VmStateOverView from '../../components/commons/vm-state-overview.vue'
import VmUserPreview from '../../components/commons/vm-user-preview.vue'
import VmProgress from '../../components/commons/vm-progress.vue'
import VmTimeline from '../../components/commons/vm-timeline.vue'
import VmTabs from '../../components/commons/vm-tabs.vue'
import VmTabsItem from '../../components/commons/vm-tabs-item.vue'
import VmWeather from '../../components/commons/vm-weather.vue'
export default {
  name: 'Dashboard',
  components: {
    VmStateOverView,
